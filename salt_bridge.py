...
sel_basic_1 = "(resid 217 244 244) and (name NH1 NE NH2 NZ)"
sel_acedic_1 = "(resname ASP GLU) and (name OD1 OD2 OE1 OE2)"

sel_basic_2 = "(resname ARG LYS) and (name NH1 NE NH2 NZ)"
sel_acedic_2 = "(resid 222 225 229 237) and (name OD1 OD2 OE1 OE2)"
...
ca_H12 = ca_1[:,1] + ca_2[:,1]
ca_H12 = ca_H12.reshape(-1,1)
...
np.savetxt('saltbridge_H12_4a2j.dat',ca_H12)
np.savetxt('saltbridge_total_4a2j.dat',ca_total)
