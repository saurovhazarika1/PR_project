...
for traj in trajectory_files:
    ...
    for ts in u.trajectory:
        ...
        n_contacts_res = np.array(np.sum(n_contacts, axis=1))
        #print(n_contacts_res.shape)
        timeseries.append(n_contacts_res)
...
np.savetxt('residue_wise_contacts_t.dat', timeseries)

print(len(timeseries[:,200]))
